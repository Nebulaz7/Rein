  ...
  return (
    ...
    >
      ...
      <div className="p-3 border-t-2 border-black/10 space-y-1">
        <button
          className={cn(
            "w-full flex items-center gap-3 px-3 py-3 rounded-lg transition-all text-left hover:bg-secondary",
          )}
        >
        ...
        {onToggleCollapse && (
          <button
            ...
            className="w-full flex items-center justify-center gap-2 px-3 py-2 rounded-lg text-muted-foreground hover:bg-secondary transition-all"
          >
            {isCollapsed ? (
