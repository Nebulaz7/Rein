      ...
      >
        <div className="bg-card border-2 border-primary p-8 relative overflow-hidden rounded-lg brutal-shadow">
          ...
          <p className="text-muted-foreground text-center mb-8 pb-4">
            To use Rein you must log into an existing account or create one
          ...
          <div className="space-y-4 pb-5">
            <button
              ...
              className="w-full cursor-pointer bg-secondary hover:bg-secondary/80 text-foreground font-semibold py-3 px-4 rounded-lg border-2 border-border hover:border-primary transition-all duration-150 flex items-center justify-center space-x-2 brutal-shadow-hover"
            >
              <svg
                className="w-5 h-5"
                viewBox="0 0 24 24"
            ...
            <button
              ...
              className="w-full cursor-pointer bg-primary hover:bg-primary/90 text-primary-foreground font-semibold py-3 px-4 rounded-lg border-2 border-primary transition-all duration-150 flex items-center justify-center space-x-2 brutal-button"
            >
              <svg
                className="w-5 h-5"
                viewBox="0 0 24 24"
